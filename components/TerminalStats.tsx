// components/scout/TerminalStats.tsx
...
export function TerminalStats() {
  return (
    <div className="grid gap-4 md:grid-cols-2">
      {stats.map((stat) => (
        <div key={stat.terminal} className="p-6 rounded-3xl bg-white/5 border border-white/10 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xl font-bold text-white">{stat.sales} Bookings</p>
            </div>
          </div>
