...
export default function Guide() {
  return (
    <section className="py-24 max-w-7xl mx-auto px-6">
      <div className="mb-16">
        <p className="uppercase text-green-500 mb-3 tracking-widest font-bold">
          The Journey
        </p>
        <div className="flex flex-wrap justify-between gap-5">
          <h2 className="text-4xl font-bold max-w-[400px]">
            Guided by Local Expertise
          </h2>
          <p className="text-gray-500 max-w-[500px]">
            Our platform connects you with vetted drivers and real-time tracking,
            ensuring you never miss a connection or feel unsafe at a terminal.
          </p>
        </div>
      </div>
