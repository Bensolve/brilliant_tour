...
export default function Hero() {
  return (
    <section className="relative pt-32 pb-16 lg:pt-48 lg:pb-32 overflow-hidden">
      {/* Background Graphic (Stolen vibe from travel_ui_ux) */}
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="flex-1 space-y-8 text-center lg:text-left">
            <Badge variant="outline" className="px-4 py-1 border-green-500 text-green-600 bg-green-50 rounded-full">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto lg:mx-0">
              ...
              or earn money by sharing the journey. No hidden fees, just brilliant travel.
            </p>

            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <Link href="/register">
                <Button size="lg" className="h-14 px-8 rounded-full bg-green-600 hover:bg-green-700 text-lg shadow-xl group">
                  Start Your Journey <MoveRight className="ml-2 group-hover:translate-x-1 transition-transform" />
                </Button>
              </Link>
          ...
          {/* This is where you'd place a high-end image of a modern bus or travelers */}
